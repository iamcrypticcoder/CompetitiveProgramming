...
/**
** DESCRIPTION:
** Given points of a polygon in some order (clockwise or counter-clockwise),
** this method returns length of perimeter, which is sum of euclidian distances
** of consecutive line segments
**
** COMPLEXITY:  O(N) N being the number of vertices of the polygon
**
** INPUT:
** List of points of a polygon (clockwise or counter-clockwise)
**
** OUTPUT:
** Length or Perimeter
**
