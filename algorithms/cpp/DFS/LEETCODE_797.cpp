/*
        ...
        Status : AC
        Time : 28 ms, faster than 26.06% of C++ online submissions for All Paths From Source to Target.
        Rank :
        Complexity:
*/
...
void generatePath(int u, vector<int>& path) {
    if (parent[u] != -1)
        generatePath(parent[u], path);
    path.push_back(u);
}
